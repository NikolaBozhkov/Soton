public class ApplianceFactory {
    ...
    /**
     * Creates an Appliance of the given type and custom consumption values, the values must be parsable to int
     * @param type the type of the Appliance
     * @param params electricity, gas and water use(optional, in that order)
     * @return the Appliance of the given type
     * @throws IllegalArgumentException
     */
    public static Appliance createAppliance(ApplianceType type, String[] params) throws IllegalArgumentException {
